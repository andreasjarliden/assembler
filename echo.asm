...
; must be set to bit mode.
	...
	out (PIO_B_CONTROL)
	ld a, 97h		; Interupt control word: interrupt enable, mask word follows TODO: allow OR
	out (PIO_B_CONTROL)
	ld a, 0ffh		; Mask all bits in PIO B
	out (PIO_B_CONTROL)
	...
	ld hl, outputInt	; TODO would like outputInt + LOAD_ADDRESS
	add hl, bc
